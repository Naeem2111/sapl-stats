		...
		return (
			<div className="text-center py-12">
				...
				<p className="mt-1 text-sm text-gray-500">
					Season statistics are only available to League Administrators and
					above.
				</p>
			</div>
		);
			...
			<div className="space-y-6">
				<div className="text-center">
					...
					<p className="text-gray-500">
						Select a season to view leagues and cups
					</p>
				</div>
		...
		return (
			<div className="space-y-6">
				...
				<div className="max-w-6xl mx-auto">
					{/* Leagues Section */}
					{competitions.filter((c) => c.type === "league").length > 0 && (
						<div className="mb-8">
							<div className="flex items-center space-x-3 mb-4">
								...
								{competitions
									...
									.map((competition) => (
										<button
											...
											className="p-6 text-left border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors"
										>
											<div className="flex items-center justify-between">
					...
					{/* Cups Section */}
					{competitions.filter((c) => c.type === "cup").length > 0 && (
						<div>
							<div className="flex items-center space-x-3 mb-4">
								<Trophy className="h-6 w-6 text-yellow-600" />
								<h3 className="text-lg font-semibold text-gray-900">Cups</h3>
							</div>
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
								{competitions
									.filter((c) => c.type === "cup")
									.map((competition) => (
										<button
											...
											className="p-6 text-left border border-gray-200 rounded-lg hover:border-yellow-300 hover:bg-yellow-50 transition-colors"
										>
											<div className="flex items-center justify-between">
												<div className="flex items-center space-x-3">
							...
							<div className="overflow-x-auto">
								<table className="min-w-full divide-y divide-gray-200">
									...
									<tbody className="bg-white divide-y divide-gray-200">
										{competitionData.teams.map((team, index) => {
